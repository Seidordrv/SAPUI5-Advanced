  ...
  return Controller.extend("logaligroup.Employees.controller.OrderDetails", {
    ...
    onSaveSignature: function (oEvent) {
      ...
      if (!signature.isFill()) {
        ...
        // this.getOwnerComponent().getModel("incidenceModel").create("/SignatureSet", body, { 
    ...
    onFileBeforeUpload: function (oEvent) {
      ...
      let onCustomerHeaderSlug = new sap.m.UploadCollectionParameter({
        name: "slug",
        value: objContext.OrderID + ";" + this.getOwnerComponent().SapId + ";" + objContext.EmployeeID + ";" + fileName
      });
      oEvent.getParameters().addHeaderParameter(onCustomerHeaderSlug);
